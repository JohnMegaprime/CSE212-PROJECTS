...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue function was inserting the person at the start of the queue, and not to the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson Function checked if people had turns, but didn't check if they had 0 or less to let them have infinite turns
